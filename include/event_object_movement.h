...
extern const u8 *const gBerryTreePaletteTagTablePointers[];
...
u8 AddPseudoEventObject(u16 graphicsId, void (*)(struct Sprite *), s16 x, s16 y, u8 subpriority, bool8 doFilter);
