...
const u8 gText_MainMenuStory[] = _("STORY");
const u8 gText_MainMenuSandbox[] = _("SANDBOX");
const u8 gText_MainMenuRandom[] = _("RANDOM");
const u8 gText_MainMenuSuperRandom[] = _("SUPER RANDOM");
const u8 gText_MainMenuNuzlocke[] = _("{COLOR_HIGHLIGHT_SHADOW GREEN DYNAMIC_COLOR1 LIGHT_GREY}NUZLOCKE");
const u8 gText_MainMenuHardlocke[] = _("{COLOR_HIGHLIGHT_SHADOW BLUE DYNAMIC_COLOR1 LIGHT_GREY}HARDLOCKE");
const u8 gText_MainMenuDeadlocke[] = _("{COLOR_HIGHLIGHT_SHADOW RED DYNAMIC_COLOR1 LIGHT_GREY}DEADLOCKE");
...
const u8 gText_CantUseRevive[] = _("You can't use revival items\nin a Nuzlocke game!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ResetDefaults[] = _("{COLOR RED}{SHADOW LIGHT_RED}RESET DEFAULT OPTIONS");
const u8 gText_DowngradeToHardlockeMode[] = _("{COLOR RED}{SHADOW LIGHT_RED}DOWNGRADE TO HARDLOCKE MODE");
const u8 gText_DowngradeToNuzlockeMode[] = _("{COLOR RED}{SHADOW LIGHT_RED}DOWNGRADE TO NUZLOCKE MODE");
const u8 gText_DisableNuzlockeMode[] = _("{COLOR RED}{SHADOW LIGHT_RED}DISABLE NUZLOCKE MODE");
const u8 gText_FreezeNuzlockeMode[] = _("{COLOR RED}{SHADOW LIGHT_RED}FREEZE NUZLOCKE MODE");
const u8 gText_OptionMenuCancel[] = _("{COLOR RED}{SHADOW LIGHT_RED}CLOSE MENU");
...
const u8 gText_DisableNuzlockeModeDescription[] = _("Turn {COLOR GREEN}Nuzlocke{COLOR DARK_GREY} mode off entirely,\nrestoring normal gameplay.");
const u8 gText_DowngradeToHardlockeModeDescription[] = _("Lowers Nuzlocke difficulty from\n{COLOR RED}Deadlocke{COLOR DARK_GREY} to {COLOR BLUE}Hardlocke{COLOR DARK_GREY} mode.");
const u8 gText_DowngradeToNuzlockeModeDescription[] = _("Lowers Nuzlocke difficulty from\n{COLOR BLUE}Hardlocke{COLOR DARK_GREY} to {COLOR GREEN}Nuzlocke{COLOR DARK_GREY} mode.");
...
const u8 gText_CantBeChanged[] = _("This option cannot be changed\nin a {STR_VAR_1} game.");
const u8 gText_Nuzlocke[] = _("{COLOR GREEN}Nuzlocke{COLOR DARK_GREY}");
const u8 gText_HardlockeOrDeadlocke[] = _("{COLOR BLUE}Hardlocke{COLOR DARK_GREY} or {COLOR RED}Deadlocke{COLOR DARK_GREY}");

const u8 gKeyboardText_QWERTY[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} QWERTY {RIGHT_ARROW_2}");
const u8 gKeyboardText_QWERTYPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} QWERTY+ {RIGHT_ARROW_2}");
const u8 gKeyboardText_ABC[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} ABC {RIGHT_ARROW_2}");
const u8 gKeyboardText_ABCPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} ABC+ {RIGHT_ARROW_2}");
const u8 gKeyboardText_AZERTY[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} AZERTY {RIGHT_ARROW_2}");
const u8 gKeyboardText_AZERTYPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} AZERTY+ {RIGHT_ARROW_2}");
const u8 gKeyboardText_Dvorak[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} DVORAK {RIGHT_ARROW_2}");
const u8 gKeyboardText_DvorakPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} DVORAK+ {RIGHT_ARROW_2}");
const u8 gKeyboardText_Colemak[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} COLEMAK {RIGHT_ARROW_2}");
const u8 gKeyboardText_ColemakPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} COLEMAK+ {RIGHT_ARROW_2}");
const u8 gKeyboardText_Vanilla[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} VANILLA {RIGHT_ARROW_2}");
	
const u8 gFontText_Rocket[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} ROCKET {RIGHT_ARROW_2}");
const u8 gFontText_Magma[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} MAGMA {RIGHT_ARROW_2}");
const u8 gFontText_Aqua[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} AQUA {RIGHT_ARROW_2}");
const u8 gFontText_Galactic[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW_2} GALACTIC {RIGHT_ARROW_2}");
...
const u8 gText_MenuWait[] = _("WAIT");
...
const u8 gText_Fainted[] = _("FAINTED:\n");
