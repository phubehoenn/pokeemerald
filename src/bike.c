...
static u8 GetBikeCollisionAt(struct EventObject *, s16, s16, u8, u8, u8);
...
static u8 GetBikeCollision(u8 direction)
{
    ...
    return GetBikeCollisionAt(playerEventObj, x, y, direction, metatileBehavior, metatileBehavior2);
}

static u8 GetBikeCollisionAt(struct EventObject *eventObject, s16 x, s16 y, u8 direction, u8 metatileBehavior, u8 metatileBehavior2)
{
    ...
    if (collision == COLLISION_NONE && (IsRunningDisallowedByMetatile(metatileBehavior) || IsRunningDisallowedByMetatile(metatileBehavior2)))
