...
void HandleLowHpMusicChange(struct Pokemon *mon, u8 battlerId)
{
	...
	// Don't play beep if low HP sound is disabled in options
	if (gSaveBlock2Ptr->optionsLowHPSound == OPTIONS_ON)
	{
...
void BattleStopLowHpSound(void)
{
	...
	// No need to do anything if low HP sound is disabled
	if (gSaveBlock2Ptr->optionsLowHPSound == OPTIONS_ON)
	{
