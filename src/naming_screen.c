...
static void NamingScreen_CreatePlayerIcon(void)
{
    ...
    spriteId = AddPseudoEventObject(rivalGfxId, SpriteCallbackDummy, 0x38, 0x25, 0, FALSE);
    gSprites[spriteId].oam.priority = 3;
...
static void NamingScreen_CreateWandaDadIcon(void)
{
    ...
    spriteId = AddPseudoEventObject(EVENT_OBJ_GFX_MAN_1, SpriteCallbackDummy, 0x38, 0x25, 0, FALSE);
    gSprites[spriteId].oam.priority = 3;
    StartSpriteAnim(&gSprites[spriteId], 4);
}
